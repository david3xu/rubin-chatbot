...
-- -- Add the fts column to the nodes_page_section table if it does not already exist
-- DO $$
-- BEGIN
--   IF NOT EXISTS (
--     SELECT 1
--     FROM information_schema.columns
--     WHERE table_name = 'nodes_page_section' AND column_name = 'fts'
--   ) THEN
--     ALTER TABLE nodes_page_section ADD COLUMN fts tsvector;
--   END IF;
-- END $$;
